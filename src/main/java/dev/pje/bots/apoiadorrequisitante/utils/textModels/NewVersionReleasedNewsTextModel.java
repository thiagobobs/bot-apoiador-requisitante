...
//			}
			...
			markdownText.append(markdown.head3("Versão " + releaseNotes.getVersion() + " do projeto " + releaseNotes.getProject() + " disponibilizada"))
//			.append(markdown.newLine())
...
//			}
			markdownText
			.append("Acesse o release notes desta versão ")
			.append(markdown.link(releaseNotes.getUrl() + 
