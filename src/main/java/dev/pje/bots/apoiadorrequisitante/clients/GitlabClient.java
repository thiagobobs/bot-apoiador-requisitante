...
public interface GitlabClient {
	...
	@PostMapping(value = "/api/v4/projects/{projectId}/releases", consumes = "application/json")
	...
	@GetMapping(value = "/api/v4/projects/{projectId}/merge_requests/{mergeRequestIid}?include_rebase_in_progress=true&include_diverged_commits_count=true", consumes = "application/json")
	public GitlabMRResponse getSingleMergeRequest(@PathVariable("projectId") String projectId, @PathVariable("mergeRequestIid") BigDecimal mergeRequestIId);

	@GetMapping(value = "/api/v4/projects/{projectId}/merge_requests/{mergeRequestIid}/changes", consumes = "application/json")
	public GitlabMRChanges getSingleMergeRequestChanges(@PathVariable("projectId") String projectId, @PathVariable("mergeRequestIid") BigDecimal mergeRequestIId);

	@PutMapping(value = "/api/v4/projects/{projectId}/merge_requests/{mergeRequestIid}/rebase", consumes = "application/json")
	public GitlabMRResponse rebaseMergeRequest(@PathVariable("projectId") String projectId, @PathVariable("mergeRequestIid") BigDecimal mergeRequestIId);
	...
	public List<GitlabMergeRequestPipeline> listMRPipelines(
			@PathVariable("projectId") String projectId,
			@PathVariable("mergeRequestIid") BigDecimal mergeRequestIId
			);

	@PostMapping(value = "/api/v4/projects/{projectId}/merge_requests/{mergeRequestIid}/pipelines", consumes = "application/json")
	public GitLabPipeline createMRPipeline(@PathVariable("projectId") BigDecimal projectId, @PathVariable("mergeRequestIid") BigDecimal mergeRequestIid);
	...
	@GetMapping(value = "/api/v4/projects/{projectId}/merge_requests/{mergeRequestIid}/notes?sort=desc&order_by=created_at", consumes = "application/json")
	public List<GitlabNote> listAllMergeRequestNotes(
			@PathVariable("projectId") String projectId,
			@PathVariable("mergeRequestIid") BigDecimal mergeRequestIId
			);
