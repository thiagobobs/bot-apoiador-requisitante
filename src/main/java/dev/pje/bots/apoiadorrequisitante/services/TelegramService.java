...
public class TelegramService {
	...
	@Value("${project.telegram.channel.message-test}") 
	private String GRUPO_MESSAGE_TEST;
...
//		logger.debug("Message user response: "+ user.toString());
	...
	public void sendBotMessage(String text) {
		sendSimpleMessage(GRUPO_MESSAGE_TEST, text, true, TelegramMessageParseModeEnum.MARKDOWN_V2);
	}
	...
	public void sendBotMessageHtml(String text) {
		sendSimpleMessage(GRUPO_MESSAGE_TEST, text, true, TelegramMessageParseModeEnum.HTML);
	}
